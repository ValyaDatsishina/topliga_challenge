from sqlalchemy import String, DateTime, func, ARRAY, Date, BigInteger, Integer, Float, ForeignKey
...
class User(Base):
    ...
    results2 = relationship("Result2", back_populates="user")
...
class Result2(Base):
    ...
    # Связь с таблицей User
    user = relationship("User", back_populates="results2")
